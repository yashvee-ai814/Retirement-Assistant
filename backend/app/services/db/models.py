...
class Session(Base):
    ...
    tool_calls: Mapped[list["ToolCall"]] = relationship("ToolCall", back_populates="session", cascade="all, delete-orphan")
...
class ToolCall(Base):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=make_uuid)
    session_id: Mapped[str] = mapped_column(String(100), ForeignKey("sessions.id"), nullable=False)
    langgraph_id: Mapped[str | None] = mapped_column(String(200), nullable=True)
